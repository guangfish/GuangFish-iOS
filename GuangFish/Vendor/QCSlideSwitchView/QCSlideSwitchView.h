...
static const CGFloat kSelectFontSizeOfTabButton = 13.0f;
static const NSUInteger kTagOfRightSideButton = 999;
static const CGFloat kWidthOfRightButton = 0.0f;
...
@property (nonatomic, assign) BOOL isRightButtonShow;
@property (nonatomic, assign) BOOL isTopHide;
